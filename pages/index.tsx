  ...
  <h3 className="text-xl text-center font-bold"> ** Lastly, We No Longer Accept Cash, Only Checks!** However, We Do Accept ApplePay Payments, and Can Accept Bank Transfers from Zelle Through Your Banking Application. 
       ...
       <div
        ...
        <div id="contact" className="flex bg-gray-200">
          ...
          <div className="container mx-auto py-2">
         <h2>eStop Driving School Provides Driving Lessons to These Locations: Novato, CA; Tiburon, CA; Petaluma, CA; San Rafael, CA; Corte Madera, CA; Sausalito, CA; Sebastopol, CA; Mill Valley, CA; San Anselmo, CA; Greenbrae CA; Kentfield, CA. If You Do Not See Your Location Listed Here; 
