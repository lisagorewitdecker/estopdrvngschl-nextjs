            ...
            <main className="main">
                ...
                <div id="training_and_services" className="bg-gray-100">
                 ...
                 <div id="new-services"
                        ...
                        <h2 className="text-2xl text-center py-3 font-bold">
                            eSTOP DRIVING SCHOOL IS OFFERING BRAND NEW ONLINE SERVICES! 
                        </h2>
                        <div className="py-3 grid xs:grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div className="p-3 flex flex-col text-center items-center">
                         <h3 className="font-bold">CA DMV APPROVED TRAFFIC SCHOOL!</h3>                          
                         ...
                         <div className="p-3 flex flex-col text-center items-center">
                         <h3 className="font-bold">350 CALIFORNIA DMV - PRACTICE QUESTIONS!</h3>                          
                          <p className="text-base"><a href="https://studyguide.estopdrivingschoolonline.com/signup" rel="noopener noreferrer" target="_blank">CLICK HERE TO SIGN-UP FOR STUDY GUIDES</a></p>
                          <p className="text-base"><a href="https://studyguide.estopdrivingschoolonline.com/login" rel="noopener noreferrer" target="_blank">CLICK HERE TO LOGIN FOR STUDY GUIDES</a></p>
                            
                    </div>
                         <div className="p-3 flex flex-col text-center items-center">
                         <h3 className="font-bold">CA DMV - DRIVERS EDUCATION ONLINE!</h3>                          
                          <p className="text-base"><a href="https://drivered.estopdrivingschoolonline.com/signup" rel="noopener noreferrer" target="_blank">CLICK HERE TO SIGN-UP FOR DRIVERS ED</a></p>
                          <p className="text-base"><a href="https://drivered.estopdrivingschoolonline.com/login" rel="noopener noreferrer" target="_blank">CLICK HERE TO LOGIN FOR DRIVERS ED</a></p>
