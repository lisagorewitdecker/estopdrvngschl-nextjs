        ...
        <div>
            ...
            <main className="main">
                ...
                <div id="training_and_services" className="bg-gray-100">
                    ...
                    </div><div id="training_and_services" class="bg-gray-100"><div class="container mx-auto py-3"><h2 class="text-2xl text-center py-3 font-bold">TRAINING &amp; SERVICES</h2><p class="text-center mx-1"><h3 class="text-xl text-center font-bold">eStop Driving School Clients Receive Valet Pick-Up and Drop-Off Services Anywhere!</h3><h3 class="text-xl text-center font-bold">You Will Be Picked Up You Up Anywhere in Marin County, Sonoma County, East Bay, and West Bay Such as San Francisco.</h3><h3 class="text-xl text-center font-bold"> No Need to Worry, You Will Safely Be Returned to The Location You Were Picked Up At. Or Even if You Need to Be Dropped Off at a Different Location Than Where You Were Picked Up!<p>&nbsp;</p>Basic Training and Services are at an Hourly Rate of $125. If You Happen To Need Additional Services, Please Do Not Hesitate To Call Or Text Tony At 415-897-7002 For More Details.<p>&nbsp;</p><b>• • WE NO LONGER Accept Cash! • • </b>However, We Do Accept ApplePay, Paypal, Checks and Zelle Payments. We Prefer to Use Zelle Due to Security and Banking Applications. We Are Very Excited to Announce that We Can Book All Appointment Bookings Online Through Google! We Are Also Working On Adding Klarna, and Afterpay, Business Accounts For Our Clients So You Can Purchase Any Driving Lesson Packages For The Ease of Our Clients.</h3></p><div class="py-3 grid xs:grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-4"><div class="p-3 flex flex-col text-center items-center" style="font-size: 12px;"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="child" class="svg-inline--fa fa-child fa-w-12 text-red-500 m-4" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" style="width: 96px; height: 96px;"><path fill="currentColor" d="M120 72c0-39.765 32.235-72 72-72s72 32.235 72 72c0 39.764-32.235 72-72 72s-72-32.236-72-72zm254.627 1.373c-12.496-12.497-32.758-12.497-45.254 0L242.745 160H141.254L54.627 73.373c-12.496-12.497-32.758-12.497-45.254 0-12.497 12.497-12.497 32.758 0 45.255L104 213.254V480c0 17.673 14.327 32 32 32h16c17.673 0 32-14.327 32-32V368h16v112c0 17.673 14.327 32 32 32h16c17.673 0 32-14.327 32-32V213.254l94.627-94.627c12.497-12.497 12.497-32.757 0-45.254z"></path></svg><h3 class="font-bold text-lg">TEENAGERS</h3><p class="text-base">Three 2-Hour Driving Lessons For Teenagers
                </div>
                <div
