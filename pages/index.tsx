          ...
          <div className="grid sm:grid-cols-1  md:grid-cols-2 gap-4">
            ...
            <div className="p-4">
              ...
              <p className="mb-2"> I have trained more than 33,000 plus teenagers  and over 5,000 adults, and seniors during my almost four decade career (of course, they are of legal driving age and status). 
                Basic training and services are at a flat hourly rate of <b>$115</b>. If you need any additional services, please do not hesitate to contact me for more details.
              </p>
              <p className="mb-2">
