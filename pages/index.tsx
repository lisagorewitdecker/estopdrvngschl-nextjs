      ...
      <main className="main">
        ...
        >
          <div className="container mx-auto py-2">
           ...
           <p class="text-center text-white mx-2”>
            CALL ME AT {" "}<a className="font-bold" href="tel:415-897-7002” target="_blank” rel="noopener noreferrer">
             a> OR EMAIL ME AT {" "}<a className="font-bold"
            href="mailto:tony@estopdrivingschool.com"
            target="_blank"
            rel="noopener noreferrer">
            a> TO SCHEDULE YOUR DRIVING TRAINING SESSION/S.
   </p>
   </div>
   </div>
